...
'INSTANT VB NOTE: The field defaultDataLayer was renamed since Visual Basic does not allow fields to have the same name as other class members:
		...
		Public Shared ReadOnly Property DefaultDataLayer() As IDataLayer
			...
			End Get
		End Property
'INSTANT VB NOTE: The variable dataStoreProvider was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Shared Sub Initialize(ByVal dataStoreProvider_Renamed As IXpoDataStoreProvider)
			Guard.ArgumentNotNull(dataStoreProvider_Renamed, "dataStoreProvider")
			SequenceGenerator.DataStoreProvider = dataStoreProvider_Renamed
		End Sub
...
'INSTANT VB NOTE: The field nextSequence was renamed since Visual Basic does not allow fields to have the same name as other class members:
