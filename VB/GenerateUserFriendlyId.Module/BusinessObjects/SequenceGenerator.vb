...
Namespace GenerateUserFriendlyId.Module
    ...
    Public Class SequenceGenerator
        ...
        Private Shared _DataStoreProvider As IXpoDataStoreProvider
            ...
            Get
                SyncLock syncRoot
                    If SequenceGenerator.defaultDataLayerField Is Nothing Then
                        Dim disposableObjects As IDisposable()
                        SequenceGenerator.defaultDataLayerField = New SimpleDataLayer(XpoTypesInfoHelper.GetXpoTypeInfoSource().XPDictionary, DataStoreProvider.CreateUpdatingStore(False, disposableObjects))
                    End If
