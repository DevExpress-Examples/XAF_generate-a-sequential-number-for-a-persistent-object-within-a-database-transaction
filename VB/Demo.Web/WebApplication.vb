...
Namespace GenerateUserFriendlyId.Web
    ...
    Public Partial Class GenerateUserFriendlyIdAspNetApplication
        ...
        Protected Overrides Sub CreateDefaultObjectSpaceProvider(ByVal args As CreateCustomObjectSpaceProviderEventArgs)
            Dim provider As XPObjectSpaceProvider = New XPObjectSpaceProvider(args.ConnectionString, args.Connection, True)
            [Module].SequenceGenerator.Initialize(Me, args.ConnectionString)
