...
namespace Demo.Module.BusinessObjects {
    ...
    public class Address : UserFriendlyIdPersistentObject {
        ...
        public string AddressId {
            get { return Convert.ToString(EvaluateAlias("AddressId")); }
        }
        public string Province {
            get { return province; }
            set { SetPropertyValue("Province", ref province, value); }
        }
        public string ZipCode {
            get { return zipCode; }
            set { SetPropertyValue("ZipCode", ref zipCode, value); }
        }
        ...
        public XPCollection<Contact> Persons {
            get { return GetCollection<Contact>("Persons"); }
        }
